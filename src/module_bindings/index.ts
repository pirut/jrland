...
import InputSampleReducer from "./input_sample_reducer";
export { InputSampleReducer };
import SendChatReducer from "./send_chat_reducer";
export { SendChatReducer };
import SetSeedReducer from "./set_seed_reducer";
export { SetSeedReducer };
...
export { Init };
import InputSample from "./input_sample_type";
export { InputSample };
...
export { SendChat };
import SetSeed from "./set_seed_type";
export { SetSeed };
...
const tablesSchema = __schema(
  ...
  __table({
    ...
    indexes: [
      ...
      { name: 'region', algorithm: 'btree', columns: [
        'region',
      ] },
    ],
    constraints: [
  ...
  __table({
    ...
    constraints: [
      { name: 'player_input_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, PlayerInputRow),
  __table({
    name: 'world',
...
const reducersSchema = __reducers(
  __reducerSchema("input_sample", InputSampleReducer),
  __reducerSchema("send_chat", SendChatReducer),
  __reducerSchema("set_seed", SetSeedReducer),
);
